...
{
    public class ContentDataEventHandler : INotificationHandler<DataEvent<Content>>
    {
        ...
        public Task Handle(DataEvent<Content> dataEvent, CancellationToken cancellationToken)
        {
